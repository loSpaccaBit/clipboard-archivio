...
- **Direct download:** [Clipboard-Archive.dmg](https://github.com/loSpaccaBit/clipboard-archivio/releases/latest/download/Clipboard-Archive.dmg) — open the DMG, double-click **Install Clipboard Archive**, or drag the app to Applications
